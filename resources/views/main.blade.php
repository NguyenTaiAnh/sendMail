...
<head>
    ...
    <title>SendMultipleEmails</title>
...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__wobble" src="dist/img/AdminLTELogo.png" alt="NguyenTaiAnh" height="60" width="60">
    </div>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; NguyenTaiAnh.</strong>
        All rights reserved.
